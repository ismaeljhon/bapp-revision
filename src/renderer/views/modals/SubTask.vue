...
export default {
    ...
    methods: {
        ...
        onSubmit() {
            ...
            return new RestApiService('/portal/' + process.env.VUE_APP_PORTAL_ID + "/projects/" + this.item.project.id + "/tasks/" + this.item.task.id + "/subtasks/").save({ params: this.form }, true)
            .then(response => {
                this.$emit('saved'),
